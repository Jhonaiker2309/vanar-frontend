...
const TimerAndTries = ({ futureTime, currentSpin }: TimerAndTriesProps) => {
  return (
    <div className="w-full md:w-[410px] p-4 flex flex-col items-center justify-center gap-4 border-[1px] bg-[#030605dd] lg:bg-transparent border-[#F6F6F60A] rounded-2xl">
