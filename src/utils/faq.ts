export const QAndA = [
  ...
  },
  {
    ...
    answer:
      'Phases are stages in part of VELOCITY Vanguard campaign. With each phase new tasks, new nft rewards geared towards learning and exploring Vanguard testnet.',
  },
  {
  ...
  {
    question:
      'Are there any airdrops or rewards for partaking in Velocity Vanguard testnet campaign?',
    answer:
      'In the VELOCITY Vanguard testnet campaign, rewards weave through the fabric of the unknown, with NFTs at each phase, offering a glimpse into deeper mysteries. These tokens, each a piece of a larger puzzle, hint at unseen potentials within the Vanar ecosystem. Beyond these enigmatic NFTs, the nature of further rewards remains cloaked in mystery, promising untold possibilities for those who venture into the campaign. With Vanar and friends, the only certainty is the allure of discovery, where the true value lies in the journey and the surprises it may unveil.',
  },
];
