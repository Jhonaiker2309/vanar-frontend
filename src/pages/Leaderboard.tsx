...
const Leaderboard = () => {
  ...
  return (
    <div className="w-full h-screen absolute flex items-center flex-col overflow-scroll gap-8 pt-40 pb-10">
      <div className="px-8 pt-8 bg-[#A08CFF] bg-opacity-10 rounded-[25px] w-5/6 md:w-2/3 h-screen md:h-full overflow-hidden pb-12">
        ...
        <div className="w-full h-full flex flex-col overflow-scroll gap-2">
          ...
          <div className="w-full h-full flex flex-col gap-2 pb-44  md:pb-12 overflow-scroll">
            {top?.map(rank => {
              ...
              const myRaking = myAccount?.toLowerCase() == account ? account?.toLowerCase() : '';
              return (
                <div
                ...
                >
                  ...
                  <p className="w-full text-xs md:text-base text-center">{formatWallet(account)}</p>
                </div>
              );
            })}
          </div>
      ...
      <div className="h-1/3 md:h-1/5 px-8 py-4 bg-[#A08CFF] bg-opacity-10 rounded-[25px] w-5/6 md:w-2/3 overflow-hidden text-white flex flex-col gap-2 md:gap-4">
